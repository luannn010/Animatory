...
export function ProductionView() {
  ...
  return (
    <div className="max-w-5xl">
      <PhaseStepperBar project={project} current="production" onRename={rename} />

      <div className="flex items-end justify-between mb-6">
        <div>
          <p className="text-[11px] font-semibold uppercase tracking-wider text-[#3772cf] font-mono mb-0.5">Phase 3</p>
          <h1 className="text-xl font-semibold text-ink tracking-tight">Production Studio</h1>
      ...
      <div className="flex justify-end border-t border-hairline mt-6 pt-5">
        <button
          onClick={sendToPost}
          className="px-4 py-2 rounded-md bg-[#3772cf] text-white text-sm font-medium hover:bg-[#2c5cab] transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#3772cf]"
        >
